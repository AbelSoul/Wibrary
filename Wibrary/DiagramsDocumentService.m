...
@implementation DiagramsDocumentService
...
+(NSArray*)getDocumentData
{
    ...
    for (docPath in folderContents)
    {
        ...
        if (iconIdentifier) {
            ...
            DiagramsDocumentService *diagramsIcon = [[DiagramsDocumentService alloc] initWithCaption:theFileName
