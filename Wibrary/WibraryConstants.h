...
#define APPENDICES_FOLDER @"/Sectional Appendices"
#define DIAGRAMS_FOLDER @"/Diagrams"
#define GOA_FOLDER @"/GOA"
#define NOTICES_FOLDER @"/Notices" // TODO - subfolders
#define PINK_PAGES_FOLDER @"/Pink Pages Dec 2011"
#define ROSTERING_FOLDER @"/Rostering"
#define RULE_BOOK_FOLDER @"/Rule Book"
#define ROSTERING_FOLDER @"/Rostering"
#define WORKING_MANUAL_FOLDER @"/Working Manual For Rail Staff"
