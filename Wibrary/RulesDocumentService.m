...
@implementation RulesDocumentService
...
+(NSArray*)getDocumentData
{
    ...
    NSString *myFolder = [documentsDirectory stringByAppendingPathComponent:@"downloads/Rule Book"];
    ...
    for (docPath in folderContents)
    {
        ...
        if (iconIdentifier) {
            ...
            RulesDocumentService *diagramsIcon = [[RulesDocumentService alloc] initWithCaption:theFileName
