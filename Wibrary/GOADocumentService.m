...
@implementation GOADocumentService
...
+(NSArray*)getDocumentData
{
    ...
    NSString *myFolder = [documentsDirectory stringByAppendingPathComponent:@"downloads/GOA"];
...
//            NSString *fullPathURLString = [folderURLString stringByAppendingString: fileNameURLString];
            ...
            GOADocumentService *diagramsIcon = [[GOADocumentService alloc] initWithCaption:theFileName
