...
@implementation ManualDocumentService
...
+(NSArray*)getDocumentData
{
    ...
    NSString *myFolder = [documentsDirectory stringByAppendingPathComponent:@"downloads/Working Manual for Rail Staff"];
    ...
    for (docPath in folderContents)
    {
        ...
        if (iconIdentifier) {
            ...
            ManualDocumentService *diagramsIcon = [[ManualDocumentService alloc] initWithCaption:theFileName
